...
/* ORIGINAL CODE: pub const SQRT_ID: FieldElement51 = field_element([ ... ]); */
...
/* ORIGINAL CODE: pub const DP1_OVER_DM1: FieldElement51 = field_element([ ... ]); */
...
/* ORIGINAL CODE: pub const MDOUBLE_INVSQRT_A_MINUS_D: FieldElement51 = field_element([ ... ]); */
pub const MDOUBLE_INVSQRT_A_MINUS_D: FieldElement51 = FieldElement51 {
    limbs: [1693982333959686, 608509411481997, 2235573344831311, 947681270984193, 266558006233600],
};

/// `= -2i/sqrt(a-d)`, where `a = -1 (mod p)`, `d` are the Edwards curve parameters
/// and `i = +sqrt(-1)`.
/* ORIGINAL CODE: pub const MIDOUBLE_INVSQRT_A_MINUS_D: FieldElement51 = field_element([ ... ]); */
pub const MIDOUBLE_INVSQRT_A_MINUS_D: FieldElement51 = FieldElement51 {
    limbs: [1608655899704280, 1999971613377227, 49908634785720, 1873700692181652, 353702208628067],
};

/// `= -1/sqrt(1+d)`, where `d` is the Edwards curve parameters.
/* ORIGINAL CODE: pub const MINVSQRT_ONE_PLUS_D: FieldElement51 = field_element([ ... ]); */
pub const MINVSQRT_ONE_PLUS_D: FieldElement51 = FieldElement51 {
    limbs: [321571956990465, 1251814006996634, 2226845496292387, 189049560751797, 2074948709371214],
};
